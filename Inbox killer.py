...
logo=(green+"""__  __ _                             ____       _
|  \/  (_)______ _ _ __  _   _ _ __  |  _ \ __ _| |__  _ __ ___   __ _ _ __
...
dtls=(yellow+"\t\tᴄʀᴇᴀᴛᴇᴅ ʙʏ : Mizanur Rahman Nirob \n \t\t@Unknown_Helper_O02\n")
...
print('					')
print(cyan+'\t\tThanks For Using My Tool! ')

os.system("xdg-open @Unknown_Helper_O02")
